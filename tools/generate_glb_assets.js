...
function pyramid() {
  ...
  tri(t, d, e, top);
  tri(t, e, a, top);
  t[0].color = [0.98, 0.90, 0.62, 0.36];
  t[1].color = [0.94, 0.74, 0.40, 0.30];
  t[2].color = [1.0, 0.95, 0.78, 0.34];
  t[3].color = [0.98, 0.78, 0.36, 0.30];
  t[4].color = [0.88, 0.64, 0.26, 0.28];
  t[5].color = [0.99, 0.86, 0.46, 0.32];
  return t;
}
...
function tetra() {
  ...
  tri(t, a, d, b);
  tri(t, b, d, c);
  t[0].color = [0.96, 1.0, 0.94, 0.36];
  t[1].color = [0.68, 0.94, 0.82, 0.30];
  t[2].color = [0.82, 0.98, 0.72, 0.34];
  t[3].color = [0.54, 0.82, 0.68, 0.28];
  return t;
}
...
function octa() {
  ...
  t[0].color = [0.90, 0.96, 1.0, 0.36];
  t[1].color = [0.62, 0.80, 0.96, 0.30];
  t[2].color = [0.76, 0.88, 1.0, 0.38];
  t[3].color = [0.50, 0.70, 0.88, 0.28];
  t[4].color = [0.98, 1.0, 1.0, 0.40];
  t[5].color = [0.80, 0.90, 0.96, 0.32];
  t[6].color = [0.56, 0.76, 0.92, 0.28];
  t[7].color = [0.70, 0.84, 0.98, 0.34];
  return t;
}
...
function prism() {
  ...
  tri(t, c, c2, a2);
  tri(t, c, a2, a);
  t[0].color = [1.0, 0.84, 0.76, 0.36];
  t[1].color = [0.92, 0.64, 0.52, 0.30];
  t[2].color = [0.80, 0.48, 0.44, 0.28];
  t[3].color = [0.98, 0.72, 0.62, 0.34];
  t[4].color = [0.88, 0.58, 0.48, 0.30];
  t[5].color = [0.72, 0.42, 0.38, 0.26];
  t[6].color = [1.0, 0.88, 0.82, 0.38];
  t[7].color = [0.94, 0.74, 0.68, 0.32];
  return t;
}
    ...
    materials: [
      {
        ...
        pbrMetallicRoughness: {
          baseColorFactor: [1.0, 1.0, 1.0, 0.34],
          metallicFactor: 0.0,
          roughnessFactor: 1.0
        },
